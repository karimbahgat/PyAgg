...
def test_text():
    ...
    canvas.draw_text("Once upon a time", (50,20), fillsize=32)
    canvas.draw_text("Someplace Near Boulder", (50,30), fillsize=12)
    canvas.draw_text("There was a reflection", (50,40), fillsize=12, anchor="e")
    canvas.draw_text("There was a reflection", (50,40), fillsize=12, anchor="w")

    canvas.draw_text("Testing text wrap testing textwrap testing. Testing textwrap.",
                     bbox=(40,60,60,80), fillsize=37, anchor="w")
    
    for d in ("nw","n","ne","e","se","s","sw","w"):
        canvas.draw_text(d, (50,50), fillsize=32,
                         anchor=d)
