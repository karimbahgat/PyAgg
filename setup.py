...
setup(	long_description=open("README.rst").read(), 
	...
	package_data={'pyagg': ['precompiled/mac/bit64/py27/aggdraw.so', 'precompiled/win/bit32/py26/aggdraw.pyd', 'precompiled/win/bit32/py27/aggdraw.pyd', 'precompiled/win/bit64/py27/aggdraw.pyd']},
	version="""0.1""",
	keywords="""graphics rendering drawing visualization imaging AGG aggdraw""",
	packages=['pyagg', 'pyagg/precompiled', 'pyagg/precompiled/mac', 'pyagg/precompiled/mac/bit64', 'pyagg/precompiled/mac/bit64/py27', 'pyagg/precompiled/win', 'pyagg/precompiled/win/bit32', 'pyagg/precompiled/win/bit32/py26', 'pyagg/precompiled/win/bit32/py27', 'pyagg/precompiled/win/bit64', 'pyagg/precompiled/win/bit64/py26', 'pyagg/precompiled/win/bit64/py27'],
	requires=['PIL'],
